// lib/features/shared/widgets.dart (Currently in widget_test.dart)
          ...
          children: [
            ...
            Row(
              children: [
                ...
                // FIX: Category ab String (non-nullable) hai, isliye isNotEmpty check lagaya
                if (ticket.category.isNotEmpty) ...[
                  const Icon(Icons.label_outline, size: 13, color: AppColors.textMuted),
                  const SizedBox(width: 3),
                  Text(ticket.category, style: AppTextStyles.caption), // null assertion (!) hataya
                  const SizedBox(width: 12),
                ],
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      // FIX: 'date' ki jagah 'slotDate' use kiya gaya hai
                      ...
                      // FIX: 'startTime' ki jagah 'timeRange' use kiya gaya hai
