...
class _BookingSheetState extends State<_BookingSheet> {
  ...
  Future<void> _confirm() async {
    ...
    if (slotId <= 0) {
      ...
      _toast(context,
          'Could not resolve a backend time slot. Please refresh and try again.',
          error: true);
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Text('Support Tickets', style: _ts(22, FontWeight.w900, _C.text1)),
            const Spacer(),
            // Refresh button
            GestureDetector(
              onTap: _load,
              child: Container(
                ...
                child: Row(children: [
                  const Icon(Icons.refresh_rounded, size: 14, color: _C.text3),
                  const SizedBox(width: 5),
                  Text('Refresh', style: _ts(12, FontWeight.w600, _C.text3)),
                ]),
              ),
            ),
            const SizedBox(width: 8),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  const Icon(Icons.mail_outlined, size: 14, color: _C.text3),
                  const SizedBox(width: 5),
