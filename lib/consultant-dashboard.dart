        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (v) {
              ...
              if (v == 'profile') setState(() => _selectedIndex = 6);
            },
            itemBuilder: (_) => [
              const PopupMenuItem(
                  value: 'profile',
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Meeting links are generated by the backend and will appear here automatically.',
                            style: TextStyle(
                              fontSize: 12,
                      ...
                      if (b.meetingMode?.toUpperCase() == 'ONLINE' &&
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: const Text(
                              'Backend will add the meeting link',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.w700,
            ...
            if ((isConfirmed || isCompleted) && schedDate.isNotEmpty) ...[
              ...
              Container(
                ...
                child: const Row(children: [
                  ...
                  Expanded(
                    child: Text(
                      'Meeting link is generated by the backend and will sync here automatically.',
                      style: TextStyle(
                        fontSize: 11,
                        color: Color(0xFF1D4ED8),
                        fontWeight: FontWeight.w600,
            ...
            children: [
              ...
              Container(
                ...
                child: const Row(children: [
                  ...
                  Expanded(
                    child: Text(
                      'For online sessions, the backend will generate the meeting ID and join link automatically after you assign the slot.',
                      style: TextStyle(
                        fontSize: 12,
                        color: Color(0xFF1D4ED8),
                        fontWeight: FontWeight.w600,
...
class _ConsultantScheduleTabState extends State<_ConsultantScheduleTab> {
  ...
  Future<void> _toggleSelectedSlots(String targetStatus) async {
    if (_selectedSlotKeys.isEmpty) {
      _snack('Please select at least one slot', false);
      return;
    }
    setState(() => _saving = true);
    var allOk = true;
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      final data = {
        ...
        if (shiftStart != null) 'shiftStartTime': shiftStart,
        if (shiftEnd != null) 'shiftEndTime': shiftEnd,
