        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final otpAction = _emailVerified
                  ? Container(
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              if (compact) {
                return Column(
                  children: [
                    _planBadge('Subscribed - Full access',
                        !_isFree(_selectedPlan ?? {}), false),
                    const SizedBox(height: 8),
                    _planBadge('Guest - Limited access',
                        _isFree(_selectedPlan ?? {}), true),
                  ],
                );
              }
              return Row(
                children: [
                  Expanded(
                    child: _planBadge('Subscribed - Full access',
                        !_isFree(_selectedPlan ?? {}), false),
                  ),
                  const SizedBox(width: 10),
                  Expanded(
                    child: _planBadge('Guest - Limited access',
                        _isFree(_selectedPlan ?? {}), true),
                  ),
                ],
              );
