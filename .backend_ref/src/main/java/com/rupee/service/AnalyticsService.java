...
public class AnalyticsService {
    ...
    public Map<String, Object> getConsultantCharts(Long consultantId) {
        ...
        return Map.of(
                ...
                "bookingActivityChart", monthlyActivity,
    ...
    public Map<String, Object> getAdminCharts() {
        ...
        // 2. User Growth Chart
        List<Map<String, Object>> rawGrowth = userRegistrationRepository.getUserGrowthMonthly();
        List<BigDecimal> monthlyGrowth = fillMissingMonthsWithZero(rawGrowth, KEY_COUNT);
        ...
        response.put("userGrowthChart", monthlyGrowth);
