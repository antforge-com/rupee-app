...
const AddAdvisor: React.FC<AddAdvisorProps> = ({ onClose, onSave }) => {
  ...
  const [skillsSourceLabel, setSkillsSourceLabel] = useState("Previous skill set");
  ...
  useEffect(() => {
    ...
    getAllSkills()
      ...
      .catch(() => {
        ...
        setSkillsSourceLabel("Previous skill set");
      });
  ...
  const inputErrorStyle = (field: string, defaultBorder = "#E2E8F0"): React.CSSProperties => ({
    border: `1.5px solid ${fieldErrors[field] ? "#FCA5A5" : defaultBorder}`,
  ...
  const validateForm = () => {
    ...
    else if (startsWithNumber(name)) nextErrors.name = "Full name cannot start with a number.";
        ...
        <form className="advisor-form" onSubmit={handleSubmit}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <div className="advisor-form-group" style={{ flex: 2 }}>
              ...
              {fieldErrors.designation && <div style={fieldErrorStyle}>{fieldErrors.designation}</div>}
            </div>
            <div className="advisor-form-group" style={{ flex: 1 }}>
              ...
              />
              {fieldErrors.yearsOfExperience && <div style={fieldErrorStyle}>{fieldErrors.yearsOfExperience}</div>}
            </div>
          </div>
          ...
          <div className="advisor-form-group">
            ...
            {selectedSkills.size > 0 && (
              <div style={{
                ...
                border: `1.5px solid ${fieldErrors.skills ? "#FCA5A5" : "#A5F3FC"}`, minHeight: 42,
              }}>
            ...
            {fieldErrors.skills && <div style={fieldErrorStyle}>{fieldErrors.skills}</div>}
          </div>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <div className="advisor-form-group" style={{ flex: 1 }}>
              ...
              <div
                ...
                style={{
                  ...
                  border: `1.5px solid ${fieldErrors.shiftStartTime ? "#FCA5A5" : (!formData.shiftStartTime ? "#E2E8F0" : "#A5F3FC")}`,
                  borderRadius: 8, fontSize: 13,
                  display: "flex", justifyContent: "space-between", alignItems: "center",
                  cursor: loading ? "not-allowed" : "pointer",
                  background: fieldErrors.shiftStartTime ? "#FFF7F7" : (loading ? "#F8FAFC" : "#fff"),
              ...
              {fieldErrors.shiftStartTime && <div style={fieldErrorStyle}>{fieldErrors.shiftStartTime}</div>}
            </div>
            ...
            <div className="advisor-form-group" style={{ flex: 1 }}>
              ...
              <div
                ...
                style={{
                  width: "100%", padding: "9px 12px",
                  border: `1.5px solid ${fieldErrors.shiftEndTime ? "#FCA5A5" : (!formData.shiftEndTime ? "#E2E8F0" : "#A5F3FC")}`,
                  borderRadius: 8, fontSize: 13,
                  display: "flex", justifyContent: "space-between", alignItems: "center",
                  cursor: loading ? "not-allowed" : "pointer",
                  background: fieldErrors.shiftEndTime ? "#FFF7F7" : (loading ? "#F8FAFC" : "#fff"),
              ...
              {fieldErrors.shiftEndTime && <div style={fieldErrorStyle}>{fieldErrors.shiftEndTime}</div>}
            </div>
          </div>
          ...
          <div className="advisor-form-group">
                ...
                return (
                  <button
                    ...
                    style={{
                      padding: "11px 10px",
                      borderRadius: 10,
                      border: `1.5px solid ${fieldErrors.slotsDurationHours ? "#FCA5A5" : (active ? "#0F766E" : "#CBD5E1")}`,
                      background: fieldErrors.slotsDurationHours ? "#FFF7F7" : (active ? "#ECFEFF" : "#fff"),
            ...
            {fieldErrors.slotsDurationHours && <div style={fieldErrorStyle}>{fieldErrors.slotsDurationHours}</div>}
          </div>
          ...
          <div className="advisor-form-group">
            ...
            {fieldErrors.charges && <div style={fieldErrorStyle}>{fieldErrors.charges}</div>}
          </div>
